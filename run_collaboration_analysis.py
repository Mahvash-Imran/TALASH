"""
run_collaboration_analysis.py  –  CLI Entry Point for Module 8
=============================================================

Usage
-----
  # Full run with LLM summaries:
  python run_collaboration_analysis.py

  # Skip LLM (rule-based summaries only, instant, no API cost):
  python run_collaboration_analysis.py --skip-llm
  ...
  python run_collaboration_analysis.py --model meta-llama/llama-4-scout-17b-16e-instruct
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("data/logs/collaboration_analysis.log", mode="a", encoding="utf-8"),
    ],
)
logger = logging.getLogger("talash.collab.main")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="TALASH Module 8 – Co-Author Collaboration Analysis"
    )
    parser.add_argument(
        "--publications-csv",
    ...
    parser.add_argument(
        ...
        help="Directory for Module 8 output files",
    )
    parser.add_argument(
        "--skip-llm",
        action="store_true",
