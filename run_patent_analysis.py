"""
run_patent_analysis.py  –  CLI Entry Point for Module 6
======================================================
...
-----
  ...
  python run_patent_analysis.py --skip-llm

  # Custom paths:
  python run_patent_analysis.py \
      --patents-csv    data/extracted/patents.csv \
      --candidates-csv data/extracted/candidates.csv \
      --output-dir     data/analysis

  # Use a specific model:
  python run_patent_analysis.py --model meta-llama/llama-4-scout-17b-16e-instruct
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("data/logs/patent_analysis.log", mode="a", encoding="utf-8"),
    ],
)
logger = logging.getLogger("talash.patent.main")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="TALASH Module 6 – Patents Analysis"
    )
    parser.add_argument(
        "--patents-csv",
        default=os.environ.get("PATENTS_CSV", "data/extracted/patents.csv"),
        help="Path to patents.csv from Module 1",
    )
    parser.add_argument(
        "--candidates-csv",
    ...
    parser.add_argument(
        ...
        help="Directory for Module 6 output files",
    )
    parser.add_argument(
        "--skip-llm",
        action="store_true",
